...
_DE = {
    ...
    'tour.newquest.text': 'Hier legst du eine eigene Quest an. Das Tool waehlt eine freie ID zwischen 381 und 399 und haengt die Quest an Tagos erste Quest an, damit sie im Spiel angeboten wird.',
...
_EN = {
    ...
    'tour.newquest.text': "Create your own quest here. The tool picks a free id between 381 and 399 and chains the quest to Tago's first quest so the game offers it.",
